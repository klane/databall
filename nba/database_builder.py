...
def add_player_game_stats(conn, season, if_exists='append'):
...
def add_player_season_stats(conn, season, if_exists='append'):
...
def add_team_game_stats(conn, season, if_exists='append'):
...
def add_team_season_stats(conn, season, if_exists='append'):
...
def build_database(start_season, end_season):
    ...
    for season in range(start_season, end_season+1):
        ...
        if season == start_season:
            add_player_game_stats(conn, season, 'replace')
            time.sleep(1)
            add_player_season_stats(conn, season, 'replace')
            time.sleep(1)
            add_team_game_stats(conn, season, 'replace')
            time.sleep(1)
            add_team_season_stats(conn, season, 'replace')
            time.sleep(1)
        else:
            add_player_game_stats(conn, season)
            time.sleep(1)
            add_player_season_stats(conn, season)
            time.sleep(1)
            add_team_game_stats(conn, season)
            time.sleep(1)
            add_team_season_stats(conn, season)
            time.sleep(1)
